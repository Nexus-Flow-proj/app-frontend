...
export const boardService = {
  ...
  reorderColumns: (projectId: string, dto: ReorderBoardColumnsDto) =>
    api
      .patch<
        ApiResponse<ApiBoardColumn[]>
      >(`/projects/${projectId}/boards/reorder`, dto)
      .then((res) => res.data),
};
...
export const taskService = {
  ...
  getTask: (taskId: string) =>
    api.get<ApiResponse<ApiTask>>(`/tasks/${taskId}`).then((res) => res.data),
  getAiAssigneeRecommendation: (projectId: string, taskId: string) =>
    api
      .get<
        ApiResponse<ApiTaskAssigneeRecommendation>
      >(`/projects/${projectId}/tasks/${taskId}/ai/assign`)
      .then((res) => res.data),
  getAiTaskBreakdown: (projectId: string, taskId: string) =>
    api
      .get<
  ...
  createTask: (projectId: string, columnId: string, dto: CreateTaskDto) =>
    api
      .post<
        ApiResponse<ApiTask>
      >(`/projects/${projectId}/tasks/${columnId}`, dto)
      .then((res) => res.data),
  ...
  deleteAttachment: (taskId: string, attachmentId: string) =>
    api
      .delete<
        ApiResponse<ApiTaskAttachmentsMutationResponse>
  ...
  deleteSubtask: (taskId: string, subtaskId: string) =>
    api
      .delete<
        ApiResponse<ApiMessageResponse>
  ...
  updateSubtask: (taskId: string, subtaskId: string, dto: UpdateSubtaskDto) =>
    api
      .patch<
        ApiResponse<ApiSubtask>
      >(`/tasks/${taskId}/subtasks/${subtaskId}`, dto)
      .then((r) => r.data),
