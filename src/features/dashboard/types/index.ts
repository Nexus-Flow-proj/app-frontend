 ...
 * Its own endpoint, independent of the other dashboard data - a short,
 * model-generated read of the user's current workload. Kept separate so it
 * can be refetched on its own (longer staleTime) without touching the rest
 * of the dashboard.
 */
